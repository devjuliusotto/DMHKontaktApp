...
export type Page = "contacts" | "calendar" | "passwords" | "import" | "export" | "trash" | "settings" | "appearance" | "simple-import" | "backup";
...
const settingsPages = new Set<Page>(["settings", "appearance", "simple-import", "import", "export", "trash", "backup"]);
