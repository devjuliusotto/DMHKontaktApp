...
contacts(id, first_name, last_name, display_name, email, private_email, second_private_email, phone, mobile_phone, private_phone, second_private_phone, company, street, postal_code, city, country, short_info, notes, import_batch_id, created_at, updated_at)
